...
__export(prismaNamespace_exports, {
  AnyNull: () => AnyNull2,
  BalancesScalarFieldEnum: () => BalancesScalarFieldEnum,
  DbNull: () => DbNull2,
  Decimal: () => Decimal2,
  JsonNull: () => JsonNull2,
  ...
  ProtectionDecisionsScalarFieldEnum: () => ProtectionDecisionsScalarFieldEnum,
  QueryMode: () => QueryMode,
  SortOrder: () => SortOrder,
  Sql: () => Sql2,
  ...
  WalletScalarFieldEnum: () => WalletScalarFieldEnum,
...
var BalancesScalarFieldEnum = {
  id: "id",
  userId: "userId",
  asset: "asset",
  reserved: "reserved",
  available: "available",
  userId_asset: "userId_asset",
  createdAt: "createdAt",
  updatedAt: "updatedAt"
};
var MarketScalarFieldEnum = {
  id: "id",
  symbol: "symbol",
  baseAsset: "baseAsset",
...
var ProtectionDecisionsScalarFieldEnum = {
  id: "id",
...
var ProtectionReason = {
  STRONG_STALE: "STRONG_STALE",
  DEVIATION: "DEVIATION",
  DEVIATION_HIGH_VOL: "DEVIATION_HIGH_VOL",
  DELAY: "DELAY",
  DELAY_HIGH_VOL: "DELAY_HIGH_VOL"
};
